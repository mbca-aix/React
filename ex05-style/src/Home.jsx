    ...
    render(){
        return (
            <div>
                ...
                <h2 style={titleStytle}>Hello React Style</h2>
                <p style={textSytle}>nice to meet you.</p>
                <p style={textSytle}>안녕하세요.</p>
                ...
                {/* 4) 외부 스타일 라이브러리 - sass/scss [라이브러리 설치 필요 npm install sass (scss모듈이 포함되어 있음)*/}
...
// 스타일을 작성하는 방법은 빽틱 영역 사용. [css문법으로.] -- vscode에서 속성명이 자동완성 되려면..확장프로그램설치[ vscode-styled-components ]
